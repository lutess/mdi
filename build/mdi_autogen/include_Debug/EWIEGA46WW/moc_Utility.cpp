...
static constexpr auto qt_meta_stringdata_CLASSUtilityENDCLASS = QtMocHelpers::stringData(
    "Utility"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSUtilityENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSUtilityENDCLASS_t qt_meta_stringdata_CLASSUtilityENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7)   // "Utility"
    },
    "Utility"
};
...
Q_CONSTINIT const QMetaObject Utility::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUtilityENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Utility, std::true_type>
    >,
    nullptr
} };
